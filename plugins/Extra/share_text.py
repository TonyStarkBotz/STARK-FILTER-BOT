...
async def share_text(client, message):
    tony = await client.ask(chat_id = message.from_user.id, text = "Now Send me your text.")
    if tony and (tony.text or tony.caption):
        input_text = tony.text or tony.caption
    else:
        await tony.reply_text(
