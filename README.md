...
Join My <a href='https://telegram.dog/TonyStark_Botz'>Update Channel</a> For More Update Regarding Repo.</b>
...
* `DATABASE_URI`: [mongoDB](https://www.mongodb.com) URI. Get this value from [mongoDB](https://www.mongodb.com). For more help watch this [video](https://youtu.be/mzc0TI3AQpE?si=GuYZ5_zmn00AeH1O)
...
* Check [info.py](https://github.com/TonyStarkBotz/Stark-Filter-Bot/blob/TonyStark/info.py) for more optional variables.</b>


<details><summary><b>Deploy To Heroku</b></summary>
<p>
<br>
<a href="https://heroku.com/deploy?template=https://github.com/TonyStarkBotz/Stark-Filter-Bot">
...
[![Deploy to Koyeb](https://www.koyeb.com/static/images/deploy/button.svg)](https://app.koyeb.com/deploy?type=git&repository=github.com/TonyStarkBotz/Stark-Filter-Bot&branch=TonyStark&name=Stark-Filter-Bot)
</details>
...
<br>
<br>
<a href="https://render.com/deploy?repo=https://github.com/TonyStarkBotz/Stark-Filter-Bot/tree/TonyStark">
...
`git clone https://github.com/TonyStarkBotz/Stark-Filter-Bot`
...
## Thanks to 
 ...
 - Thanks To [Tony Stark](https://youtube.com/@TonyStarkBotz) To Modify And Add Amazing Feature In The Repo
 - Thanks To [Eva Marie](https://t.me/TeamEvamaria) For Base Repo
 - Thanks To All Everyone In This Journey</b>

## Note 🏷️
 
* [![Contact Developer](https://img.shields.io/static/v1?label=Contact+Developer&message=On+Telegram&color=critical)](https://telegram.me/Tony_Stark_75)

<b>[Note To A So Called Dev](https://telegram.dog/TonyStark_Botz): 

Fork The Repo And Edit As Per Your Needs.</b>

## Disclaimer
[![GNU Affero General Public License 2.0](https://www.gnu.org/graphics/agplv3-155x51.png)](https://www.gnu.org/licenses/agpl-3.0.en.html#header)    
<b>Licensed under [GNU AGPL 2.0.](https://github.com/TonyStarkBotz/Stark-Filter-Bot/blob/TonyStark/LICENSE)
